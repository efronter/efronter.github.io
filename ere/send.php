<?php
	...
	$to = "ereke.nurmahan@mail.ru"; // Задаем получателя письма
	$from = "https://efronter.github.io"; // От кого пришло письмо
	$subject = "Письмо с примера простой формы сайта https://efronter.github.io"; // Задаем тему письма
